...
import com.example.tahuuduc_duan1_admin.adapter.DonHangChiTietAdapter;
import com.example.tahuuduc_duan1_admin.adapter.ShipperSpinnerAdapter;
...
public class ChiTietDonHangFragment extends Fragment {
    ...
    private void setUpOtherComponent() {
        ...
        List<TrangThai> trangThaiList = new ArrayList<>(Arrays.asList(TrangThai.values()));

        //set TRang thai cua don hang
